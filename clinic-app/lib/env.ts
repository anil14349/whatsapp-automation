...
const serverEnvSchema = z.object({
  ...
  // WhatsApp Flows (native in-chat booking form) — all optional. Unset
  // means the ENABLE_WHATSAPP_FLOW_BOOKING setting has nothing to turn
  // on; the bot falls back to the list/button booking flow exactly as
  // it does today. See clinic-app/README.md's WhatsApp Flows section.
  WHATSAPP_FLOW_ID: z.string().optional().or(z.literal("")),
  // PEM-encoded RSA private key generated by scripts/generate-flow-keypair.mjs
  // (or openssl) — keep the literal "\n" sequences, same convention as
  // GOOGLE_SERVICE_ACCOUNT_PRIVATE_KEY above; lib/whatsapp/flowCrypto.ts
  // un-escapes them.
